...
export const metadata: Metadata = {
  ...
  description:
    '100+ cottagecore coloring pages instantly, plus 30 new ones every month. Print at home or color on your iPad. More pages than any coloring book at the store — just $7/mo. Cancel anytime.',
};
      ...
      <section className="pt-12 pb-16 md:pt-16 md:pb-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-bark/70 text-lg md:text-xl max-w-lg mx-auto mb-8 leading-relaxed">
            100+ cottagecore coloring pages instantly, plus 30 new ones every month.
        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="space-y-3">
            ...
            <FaqItem
              ...
              answer="Instant access to 100+ coloring pages — wildflower gardens, cozy cottages, woodland creatures, botanicals, mandalas, and more. Plus 30 brand-new pages arrive every month. PDF and PNG formats included."
            />
            <FaqItem
